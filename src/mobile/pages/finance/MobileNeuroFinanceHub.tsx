    ...
    <div className="space-y-6">
      ...
      <section className="space-y-3">
        ...
        <div className="grid gap-2">
          ...
          <MobileActionListItem icon={Receipt} title="Gerar QR Code" description="Crie uma cobrança Pix para paciente ou pagador externo." status="Ativo" onClick={() => navigate(`${base}/pix/qrcode`)} />
