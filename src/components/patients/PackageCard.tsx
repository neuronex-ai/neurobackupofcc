...
export const PackageCard = ({ pkg, patientId }: PackageCardProps) => {
    ...
    return (
        ...
        >
            <div className="absolute inset-0 bg-gradient-to-br from-white to-zinc-50 dark:from-zinc-900 dark:to-black rounded-[28px]" />

            <div className="relative bg-white/50 dark:bg-zinc-900/50 backdrop-blur-xl p-6 rounded-[27px] flex flex-col gap-6 border border-zinc-200 dark:border-zinc-800">
                <div className="flex items-start justify-between">
                    ...
                    <DropdownMenu>
                        <DropdownMenuTrigger asChild>
                            <Button variant="ghost" size="icon" className="h-9 w-9 text-zinc-400 hover:text-zinc-900 dark:hover:text-white hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded-xl">
                                <MoreVertical className="h-4 w-4" />
                            </Button>
                        </DropdownMenuTrigger>
                        <DropdownMenuContent align="end" className="bg-white/95 dark:bg-zinc-950/95 backdrop-blur-xl border-zinc-200 dark:border-zinc-800 rounded-2xl p-1.5 shadow-2xl">
                            <EditPackageModal pkg={pkg}>
                                <DropdownMenuItem onSelect={(e) => e.preventDefault()} className="cursor-pointer text-[10px] font-black uppercase tracking-widest gap-2.5 p-2.5 rounded-xl hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-700 dark:text-zinc-300 focus:text-zinc-900 dark:focus:text-white">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <div className="flex flex-col gap-1.5 p-4 rounded-2xl bg-zinc-50 dark:bg-zinc-950/50 border border-zinc-200/50 dark:border-zinc-800/50">
                    ...
                    <div className="flex flex-col gap-1.5 p-4 rounded-2xl bg-zinc-50 dark:bg-zinc-950/50 border border-zinc-200/50 dark:border-zinc-800/50 text-right">
                ...
                <div className="pt-6 border-t border-zinc-200 dark:border-zinc-800 flex items-center justify-between mt-2">
                    ...
                    <Button
                        ...
                        className={cn(
                            ...
                            isCompleted || isExpired
                                ? "bg-zinc-100 text-zinc-400 dark:bg-zinc-800 dark:text-zinc-600 shadow-none border border-zinc-200 dark:border-zinc-700"
            ...
            <AlertDialog open={isConfirmingDelete} onOpenChange={setIsConfirmingDelete}>
                <AlertDialogContent className="bg-white/95 dark:bg-zinc-950/95 backdrop-blur-2xl border border-zinc-200 dark:border-zinc-800 rounded-[32px] p-8 shadow-2xl max-w-[400px]">
                    <AlertDialogHeader>
                    ...
                    <AlertDialogFooter className="mt-8 gap-3">
                        <AlertDialogCancel className="h-11 rounded-2xl border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-900 hover:bg-zinc-100 dark:hover:bg-zinc-800 text-zinc-900 dark:text-white text-[10px] font-black uppercase tracking-widest">Cancelar</AlertDialogCancel>
                        <AlertDialogAction
