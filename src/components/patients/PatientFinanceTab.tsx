...
export const PatientFinanceTab = ({ patientId }: PatientFinanceTabProps) => {
  ...
  return (
    <div className={cn("animate-fade-in pb-10", isMobile ? "space-y-8" : "space-y-10")}>
      ...
      <GlassCard 
        className="!bg-white dark:!border-white/[0.085] dark:!bg-[#0b0b0d] dark:!shadow-[0_24px_62px_-46px_rgba(0,0,0,0.96),inset_0_1px_0_rgba(255,255,255,0.026)] relative overflow-hidden"
