    ...
    return (
        <section className="relative w-full flex flex-col items-center justify-start z-10 min-h-screen overflow-hidden bg-background">
            ...
            <div className="absolute inset-0 z-0 overflow-hidden">
                ...
                <div className="absolute inset-0 z-[2] bg-[radial-gradient(circle_at_50%_40%,hsl(var(--primary)/0.15)_0%,transparent_70%)]" />
            ...
            <motion.div
                ...
                className="relative z-10 text-center flex flex-col items-center w-full max-w-5xl mx-auto pt-[16vh] md:pt-[20vh] lg:pt-[24vh] px-4"
            >
                <FadeIn delay={0.3}>
                    <div className="inline-flex items-center gap-2 bg-foreground/[0.03] border border-border/10 rounded-full px-5 py-1.5 mb-8 backdrop-blur-sm">
                        <span className="text-[11px] uppercase tracking-[0.25em] font-black text-foreground/80">NeuroNex AI</span>
                    </div>
                </FadeIn>
                ...
                <div className="mb-4 md:mb-6">
                    <TextReveal stagger={0.08} className="text-[2.6rem] sm:text-[3.2rem] md:text-[4rem] lg:text-[5.8rem] xl:text-[6.2rem] font-bold tracking-tight text-foreground leading-[1] md:leading-[0.92] select-none text-center">
                        Sua Clínica, Por Comando de Voz.
                    </TextReveal>
                </div>

                <FadeIn delay={0.6}>
                    <p className="text-base md:text-xl lg:text-2xl text-muted-foreground/70 font-medium max-w-3xl mx-auto leading-relaxed md:leading-[1.4] tracking-tight mb-8 md:mb-10 lg:mb-12 px-2">
                        O sistema operacional definitivo para psicólogos de elite.<br className="hidden sm:block" />
                        Prontuário, agenda e inteligência em perfeita simbiose.
                    </p>
                </FadeIn>
