...
export function BillPaymentProcessing() {
  ...
  return (
    <section className="relative mx-auto min-h-[540px] max-w-3xl overflow-hidden rounded-[36px] border border-white/[0.08] bg-[#050507] p-8 text-white shadow-[0_45px_140px_-45px_rgba(0,0,0,0.85)] md:p-12">
      ...
      <div className="pointer-events-none absolute bottom-0 right-0 h-52 w-52 rounded-full bg-emerald-500/10 blur-[90px]" />
      ...
      <div className="relative flex min-h-[440px] flex-col items-center justify-center">
        <div className="relative mb-10 flex h-28 w-28 items-center justify-center">
          ...
          />
          <motion.div
            className="absolute inset-3 rounded-full border border-blue-400/25"
            animate={{ rotate: 360 }}
        ...
        <motion.h3
          ...
          className="mt-3 text-center text-2xl font-black tracking-tight md:text-3xl"
        >
          {STEPS[activeStep].label}
        </motion.h3>
        <p className="mt-3 max-w-md text-center text-xs leading-relaxed text-zinc-500">
          Não feche esta tela. Estamos protegendo e acompanhando cada etapa da solicitação.
        </p>
