...
import { Mail, MapPin, Phone, Send, MessageSquare, CheckCircle2, Loader2, Globe } from "lucide-react";
                ...
                <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-32 lg:gap-48 items-start">
                    ...
                    <div className="space-y-24 order-2 lg:order-1 relative z-10">
                        ...
                        <div className="space-y-12 pl-4 border-l border-border/20">
                            <ContactInfo icon={Mail} label="Interface Digital" value="intelligence@neuronex.ai" delay={0.3} />
                            <ContactInfo icon={Phone} label="Terminal Prime" value="+55 (11) 98888-7777" delay={0.4} />
                            <ContactInfo icon={MapPin} label="Base de Operação" value="Faria Lima Financial Center, SP" delay={0.5} />
                        </div>
                        ...
                        <FadeIn delay={0.6}>
                            <div className="h-72 rounded-[56px] border border-border/30 bg-card/40 backdrop-blur-3xl overflow-hidden relative group shadow-premium gpu-accelerated transition-all duration-1000 hover:border-foreground/30">
                                ...
                                <div className="absolute bottom-10 left-12 z-10 space-y-2">
                                    <p className="text-[10px] font-black uppercase tracking-[0.4em] text-muted-foreground/30">Infraestrutura NeuroNex HQ</p>
                                    <p className="text-xl font-bold text-foreground tracking-tighter">Global Node: 01-SP-BR</p>
                                </div>
                            </div>
                        </FadeIn>
                    </div>
