...
Para listar todas as chaves, basta omitir os filtros: `GET https://api.asaas.com/v3/pix/addressKeys`

Para listar apenas as chaves com um determinado status, basta informar o parâmetro status com o valor do `status` desejado: `GET https://api.asaas.com/v3/pix/addressKeys?status=ACTIVE`

Para listar chaves com diferentes status, basta informar o parâmetro `statusList` com um array de status: `GET https://api.asaas.com/v3/pix/addressKeys?statusList=ACTIVE,AWAITING_DELETION`
      ...
      "get": {
        ...
        "parameters": [
          ...
          },
          {
            "name": "status",
            "in": "query",
            "description": "Filtrar pelo status atual da chave",
            "schema": {
              "$ref": "#/components/schemas/PixAddressKeyListRequestPixAddressKeyStatus"
            }
          },
          {
            "name": "statusList",
            "in": "query",
            "description": "Filtrar por um ou mais status das chaves",
            "schema": {
              "type": "string",
              "example": null
            }
        ...
        "responses": {
          "200": {
            ...
            "content": {
              "application/json": {
                "schema": {
                  "$ref": "#/components/schemas/PixAddressKeyListResponseDTO"
                }
              }
            }
          },
